...
const TextStyle heading1 = TextStyle(
    fontSize: 30, color: primaryMedLabOColor, fontWeight: FontWeight.w700);
const TextStyle heading2 = TextStyle(
    fontSize: 20, color: primaryMedLabOColor, fontWeight: FontWeight.w500);
const TextStyle heading3 = TextStyle(
    fontSize: 15, color: primaryMedLabOColor, fontWeight: FontWeight.w300);

//article texts
const TextStyle articleTextBig =
    TextStyle(fontSize: 18, color: primaryMedLabOColor);
const TextStyle articleTextMedium =
    TextStyle(fontSize: 15, color: primaryMedLabOColor);
const TextStyle articleTextSmall =
    TextStyle(fontSize: 13, color: primaryMedLabOColor);
