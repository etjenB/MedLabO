...
class RacuniProvider with ChangeNotifier {
  ...
  Future<Racun> getRacunByTerminID(String terminID) async {
    var url = '${BaseProvider.baseUrl}$endpoint/GetRacunByTerminID/$terminID';
