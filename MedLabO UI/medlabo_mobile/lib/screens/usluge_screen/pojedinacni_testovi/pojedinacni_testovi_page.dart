...
class PojedinacniTestoviPage extends StatefulWidget {
  const PojedinacniTestoviPage({super.key});

  @override
  State<PojedinacniTestoviPage> createState() => _PojedinacniTestoviPageState();
}

class _PojedinacniTestoviPageState extends State<PojedinacniTestoviPage> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      final newItems = await _testoviProvider.get(
