        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("cc379f98-3f7e-4f69-a7a3-4654b15e9954"), 14m, true, null },
            ...
            migrationBuilder.InsertData(
                table: "Rezultati",
                columns: new[] { "RezultatID", "DTRezultata", "Obiljezen", "RazlikaOdNormalne", "RezFlo", "RezStr", "TestZakljucak" },
                values: new object[,]
                {
                    { new Guid("ab949483-d2ec-4f94-9c5e-08dc0ac6a180"), new DateTime(2024, 1, 1, 16, 0, 0, 0, DateTimeKind.Unspecified), false, null, 5f, null, "nor" },
                    { new Guid("d4395013-e4a1-4c9b-9c5f-08dc0ac6a180"), new DateTime(2024, 1, 1, 16, 0, 0, 0, DateTimeKind.Unspecified), false, null, null, "Negativno", "nor" },
                    { new Guid("d4e7df29-a213-4c94-9c5d-08dc0ac6a180"), new DateTime(2024, 1, 1, 16, 0, 0, 0, DateTimeKind.Unspecified), true, 7f, 12f, null, "povišen" },
                    { new Guid("f86ee7f0-c7bb-49e7-9c60-08dc0ac6a180"), new DateTime(2024, 1, 1, 16, 0, 0, 0, DateTimeKind.Unspecified), false, null, null, "Negativno", "nor" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Zakljucci",
                columns: new[] { "ZakljucakID", "Detaljno", "Opis", "TerminID" },
                values: new object[] { new Guid("cf32ff76-7659-4c4f-b73e-d9dbc841f409"), "Povećan CRP ukazuje potencijalno postojeću upalu ili period poslije upale, te u tom slučaju bi se CRP u narednom periodu trebo vraćati u normalne okvire.", "Povećan CRP", null });

            migrationBuilder.InsertData(
                table: "Zvanja",
                columns: new[] { "ZvanjeID", "Naziv", "Opis" },
                values: new object[] { 1, "Ljekar", "Ljekar u medicinskom laboratoriju specijaliziran je za analizu bioloških uzoraka, dijagnosticiranje bolesti i savjetovanje ostalih zdravstvenih radnika, koristeći naprednu laboratorijsku tehnologiju." });

            migrationBuilder.InsertData(
                table: "Zvanja",
                columns: new[] { "ZvanjeID", "Naziv", "Opis" },
                values: new object[] { 2, "Laboratorijski tehničar", "U medicinskom laboratoriju, laboratorijski tehničar precizno izvodi testiranja, održava laboratorijsku opremu i pomaže u interpretaciji rezultata testova." });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0c1a4613-be50-48a6-abcb-a535870fe369"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 3.5m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(7988), "Nema posebnih uputa.", "CRP", "Marker za upalu u tijelu.", new byte[0], new Guid("0fe0697a-aa20-4e20-b152-58f6ed44efc3"), "Krv" },
                    { new Guid("0c9db61b-d5e5-495d-876b-30ad80a8df3d"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 4.5m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8146), "Jutarnji sputum.", "Citologija sputuma", "Analiza sputuma za otkrivanje abnormalnih stanica.", new byte[0], new Guid("75b1dbb5-6b3c-4c76-8044-caff96608e08"), "Sputum" },
                    { new Guid("14a35eb5-c4bd-4a0b-9990-c8b493367bcf"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 3m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8022), "Nema posebnih uputa.", "Bilirubin", "Mjerenje bilirubina, važno za otkrivanje bolesti jetre i žučnih puteva.", new byte[0], new Guid("77886ff8-caf5-4247-ae64-62e1a8c0969f"), "Krv" },
                    { new Guid("1c978bd5-9777-4c05-b2ae-de4d3b9b4fc5"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 2.5m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8062), "Post od 12 sati prije testa.", "Holesterol", "Mjerenje ukupnog holesterola, važno za procjenu rizika od kardiovaskularnih bolesti.", new byte[0], new Guid("e8e1e4b9-7fe9-4015-9f62-f3c844e831ce"), "Krv" },
                    { new Guid("20b1bda2-14bc-4b3f-bac4-598e2a292519"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 2.5m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8110), "Post od 12 sati prije testa.", "Trigliceridi", "Mjerenje triglicerida, važno za procjenu rizika od srčanih bolesti.", new byte[0], new Guid("e4f11b51-c4e6-473d-9221-c617354745f3"), "Krv" },
                    { new Guid("54d120fc-224a-4710-9046-162d9b61c2d7"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 2.5m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(7841), "Nema posebnih uputa.", "Eritrociti", "Broj eritrocita, važan za dijagnozu anemije i drugih poremećaja.", new byte[0], new Guid("bab9d588-8ff1-4355-96fd-f94d9bdb4a8d"), "Krv" },
                    { new Guid("59a5aaae-ec61-476d-84f5-2621d4054160"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 5m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8182), "Nema posebnih uputa.", "Nasalni bris za MRSA", "Testiranje na prisutnost MRSA (meticilin-rezistentni Staphylococcus aureus) u nosnoj šupljini.", new byte[0], new Guid("84bfaf38-20b5-4648-b8f0-9d2c4cf7b95a"), "Nasalni bris" },
                    { new Guid("8fff236b-4a25-4ed3-a138-f252ee4770eb"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 2.5m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(7807), "Nema posebnih uputa.", "Leukociti", "Broj leukocita, važan za otkrivanje infekcija ili upalnih procesa.", new byte[0], new Guid("d70a4bfa-38c0-4d41-a090-208404e57209"), "Krv" },
                    { new Guid("a4a12d1c-b174-4938-8557-cb6281ccb2a6"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 2m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(7954), "Nema posebnih uputa.", "Sedimentacija", "Brzina sedimentacije eritrocita, indikator upalnih procesa.", new byte[0], new Guid("788e2d86-4fc5-49a8-994e-541180dba9bb"), "Krv" },
                    { new Guid("ad25cc31-2b01-4ad3-bf2e-1fe4b53a3f25"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 3m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(7912), "Nema posebnih uputa.", "AST", "Enzim važan za otkrivanje oštećenja jetre.", new byte[0], new Guid("901a4f75-3529-4b57-b9c0-8dd99f495d32"), "Krv" },
                    { new Guid("d687ff9d-1ec4-4aa9-a4f3-2eb5149d2212"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 2m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(7759), "Post od 8 sati prije testa.", "Glukoza", "Mjerenje glukoze u krvi, važno za dijagnozu i praćenje dijabetesa.", new byte[0], new Guid("46cba49e-0b4b-4018-ae70-5c9ceae529b5"), "Krv" },
                    { new Guid("d9f7156c-a460-4a7c-b51c-ef7d859244af"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 3m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8216), "Jutarnji urin.", "Urinarni albumin", "Mjerenje albumina u urinu, indikator oštećenja bubrega.", new byte[0], new Guid("e16fecb2-a4cf-41fd-a264-18dbc8a25cc8"), "Urin" },
                    { new Guid("ef16a7e3-3117-4246-ae58-fc54d2307c77"), new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 3m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(7874), "Nema posebnih uputa.", "MCHC", "Prosječna koncentracija hemoglobina u eritrocitu.", new byte[0], new Guid("e8319b5a-0868-4fef-b356-32f9fdabbd82"), "Krv" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 6m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8238), null, true, "Krvna slika", "Mjerenje osnovnih testova vezanih za krvnu sliku.", 24f, null, 10 },
                    { 2, new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 8m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8258), null, true, "Jetreni panel", "Kompletna analiza funkcije jetre.", 24f, null, 15 },
                    { 3, new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 4m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8275), null, true, "Kardiovaskularni rizik", "Procjena rizika od kardiovaskularnih bolesti.", 24f, null, 10 },
                    { 4, new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 5m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8292), null, true, "Upalni marker", "Testiranje za otkrivanje upalnih procesa u tijelu.", 24f, null, 10 },
                    { 5, new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 4m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8313), null, true, "Bubrežni panel", "Procjena funkcije bubrega i rizika od dijabetesa.", 24f, null, 15 },
                    { 6, new Guid("e6bb3c49-9aa6-4ef0-9625-b16bb3775e58"), 9m, new DateTime(2024, 1, 1, 17, 10, 56, 197, DateTimeKind.Local).AddTicks(8332), null, true, "Respiratorni panel", "Analiza respiratornog sistema za otkrivanje infekcija.", 48f, null, 20 }
                });
...
migrationBuilder.InsertData(
    ...
    values: new object[,]
    {
		...
		{ 4, Guid.Parse("3C8F2E71-BB3C-456C-9914-CB98E7E165A9") },
        { 6, Guid.Parse("3C8F2E71-BB3C-456C-9914-CB98E7E165A9") }
    }
);
    ...
    values: new object[,]
    {
		{ Guid.Parse("0C1A4613-BE50-48A6-ABCB-A535870FE369"), Guid.Parse("3C8F2E71-BB3C-456C-9914-CB98E7E165A9"), Guid.Parse("D4E7DF29-A213-4C94-9C5D-08DC0AC6A180") },
		{ Guid.Parse("A4A12D1C-B174-4938-8557-CB6281CCB2A6"), Guid.Parse("3C8F2E71-BB3C-456C-9914-CB98E7E165A9"), Guid.Parse("AB949483-D2EC-4F94-9C5E-08DC0AC6A180") },
		{ Guid.Parse("59A5AAAE-EC61-476D-84F5-2621D4054160"), Guid.Parse("3C8F2E71-BB3C-456C-9914-CB98E7E165A9"), Guid.Parse("D4395013-E4A1-4C9B-9C5F-08DC0AC6A180") },
        { Guid.Parse("0C9DB61B-D5E5-495D-876B-30AD80A8DF3D"), Guid.Parse("3C8F2E71-BB3C-456C-9914-CB98E7E165A9"), Guid.Parse("F86EE7F0-C7BB-49E7-9C60-08DC0AC6A180") }
    }
);
...
migrationBuilder.Sql("UPDATE Termini SET RacunID = 'CC379F98-3F7E-4F69-A7A3-4654B15E9954' WHERE TerminID = '3C8F2E71-BB3C-456C-9914-CB98E7E165A9';");migrationBuilder.Sql("UPDATE Racuni SET TerminID = '3C8F2E71-BB3C-456C-9914-CB98E7E165A9' WHERE RacunID = 'CC379F98-3F7E-4F69-A7A3-4654B15E9954';");

migrationBuilder.Sql("UPDATE Termini SET ZakljucakID = 'CF32FF76-7659-4C4F-B73E-D9DBC841F409' WHERE TerminID = '3C8F2E71-BB3C-456C-9914-CB98E7E165A9';");migrationBuilder.Sql("UPDATE Zakljucci SET TerminID = '3C8F2E71-BB3C-456C-9914-CB98E7E165A9' WHERE ZakljucakID = 'CF32FF76-7659-4C4F-B73E-D9DBC841F409';");
