...
namespace MedLabO.Services.Migrations
{
    ...
    [Migration("20231024195238_007-zvanje-id-change")]
    partial class _007zvanjeidchange
    {
            ...
            modelBuilder.Entity("MedLabO.Services.Database.MedicinskoOsoblje", b =>
                {
                    ...
                    b.Property<int?>("ZvanjeNewId")
                        .HasColumnType("int");

                    b.HasIndex("SpolID");

                    b.HasIndex("ZvanjeNewId");
            ...
            modelBuilder.Entity("MedLabO.Services.Database.MedicinskoOsoblje", b =>
                {
                    ...
                    b.HasOne("MedLabO.Services.Database.Zvanje", null)
                        .WithMany("MedicinskoOsoblje")
                        .HasForeignKey("ZvanjeNewId");
